...
WebUI.setText(findTestObject('Login/input_Login_username'), GlobalVariable.nikEmployeeAdmin)

'User Employee Input Password'
WebUI.setText(findTestObject('Login/input_Login_password'), GlobalVariable.passwordEmployeeAdmin)
...
'The user employee view a text element to verify the superordinate info "ADMINTEST_3"'
WebUI.verifyElementText(findTestObject('Admin/Dashboard/span_name atasan'), 'ADMINTEST_3')
