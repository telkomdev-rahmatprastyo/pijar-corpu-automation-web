...
'User Employee as Management/Atasan'
WebUI.callTestCase(findTestCase('CustomKeyword In TestCase/Login User Employee as Management'), [:], FailureHandling.OPTIONAL)
...
WebUI.verifyElementText(findTestObject('Learner/Request For Enrollment/Succes Request For Enrollment/Congratulation'), 
    'Congratulation!')

'Users view a text element to verify succes save data "Data saved!"'
WebUI.verifyElementText(findTestObject('Learner/Request For Enrollment/Succes Request For Enrollment/Data saved'), 
    'Data saved!')
